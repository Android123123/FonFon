...
import com.fonfon.commons.extensions.getIntValue
import com.fonfon.commons.extensions.getStringValue
import com.fonfon.commons.models.PhoneNumber
import com.fonfon.commons.models.SimpleContact
...
class MyContactsContentProvider {
    companion object {
        private const val AUTHORITY = "com.fonfon.commons.contactsprovider"
        ...
        fun getSimpleContacts(context: Context, cursor: Cursor?): ArrayList<SimpleContact> {
            ...
            if (packageName != "com.fonfon.dialer" && packageName != "com.fonfon.smsmessenger" && packageName != "com.fonfon.calendar.pro") {
                return contacts
            }
