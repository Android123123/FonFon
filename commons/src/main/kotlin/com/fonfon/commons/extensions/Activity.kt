...
import com.fonfon.commons.compose.extensions.DEVELOPER_PLAY_STORE_URL
import com.fonfon.commons.databinding.DialogTitleBinding
import com.fonfon.commons.dialogs.*
import com.fonfon.commons.dialogs.WritePermissionDialog.WritePermissionDialogMode
import com.fonfon.commons.helpers.*
import com.fonfon.commons.models.*
...
fun Activity.launchPurchaseThankYouIntent() {
    hideKeyboard()
    try {
        launchViewIntent("market://details?id=com.fonfon.thankyou")
...
fun Activity.openPathIntent(
    ...
    ensureBackgroundThread {
        ...
        Intent().apply {
            ...
            if (applicationId == "com.fonfon.gallery.pro" || applicationId == "com.fonfon.gallery.pro.debug") {
...
fun BaseSimpleActivity.launchCallIntent(recipient: String, handle: PhoneAccountHandle? = null) {
    handlePermission(PERMISSION_CALL_PHONE) {
        ...
        Intent(action).apply {
            ...
            if (isDefaultDialer()) {
                val packageName = if (baseConfig.appId.contains(".debug", true)) "com.fonfon.dialer.debug" else "com.fonfon.dialer"
                val className = "com.fonfon.dialer.activities.DialerActivity"
