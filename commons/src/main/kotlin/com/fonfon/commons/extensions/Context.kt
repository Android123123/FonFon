...
import com.fonfon.commons.models.AlarmSound
...
fun Context.getFilePublicUri(file: File, applicationId: String): Uri {
    ...
    // if media content uri is null, get our custom uri like content://com.fonfon.gallery.provider/external_files/emulated/0/DCIM/IMG_20171104_233915.jpg
...
fun Context.isThankYouInstalled() = isPackageInstalled("com.fonfon.thankyou")
...
fun Context.isAProApp() = packageName.startsWith("com.fonfon.") && packageName.removeSuffix(".debug").endsWith(".pro")
...
fun Context.getCanAppBeUpgraded() = proPackages.contains(baseConfig.appId.removeSuffix(".debug").removePrefix("com.fonfon."))
...
fun Context.isDefaultDialer(): Boolean {
    return if (!packageName.startsWith("com.fonfon.contacts") && !packageName.startsWith("com.fonfon.dialer")) {
        true
    } else if ((packageName.startsWith("com.fonfon.contacts") || packageName.startsWith("com.fonfon.dialer")) && isQPlus()) {
