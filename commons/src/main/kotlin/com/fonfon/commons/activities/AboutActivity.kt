...
import com.fonfon.commons.compose.extensions.rateStarsRedirectAndThankYou
import com.fonfon.commons.compose.screens.*
import com.fonfon.commons.compose.theme.AppThemeSurface
import com.fonfon.commons.dialogs.ConfirmationAdvancedAlertDialog
import com.fonfon.commons.dialogs.RateStarsAlertDialog
import com.fonfon.commons.extensions.*
...
class AboutActivity : ComponentActivity() {
    ...
    private fun launchEmailIntent() {
        ...
        val address = if (packageName.startsWith("com.fonfon")) {
    ...
    private fun onFacebookClick() {
        var link = "https://www.facebook.com/fonfon"
        try {
    ...
    private fun onGithubClick() {
        launchViewIntent("https://github.com/fonfon")
    }

    private fun onRedditClick() {
        launchViewIntent("https://www.reddit.com/r/fonfon")
    }


    private fun onTelegramClick() {
        launchViewIntent("https://t.me/fonfon")
    }


    private fun onWebsiteClick() {
        launchViewIntent("https://fonfon.com/")
    }

    private fun onPrivacyPolicyClick() {
        val appId = baseConfig.appId.removeSuffix(".debug").removeSuffix(".pro").removePrefix("com.fonfon.")
        val url = "https://fonfon.com/privacy/$appId.txt"
