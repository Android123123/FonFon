...
import com.fonfon.commons.compose.extensions.onEventValue
import com.fonfon.commons.compose.screens.ManageBlockedNumbersScreen
import com.fonfon.commons.compose.theme.AppThemeSurface
import com.fonfon.commons.dialogs.AddOrEditBlockedNumberAlertDialog
import com.fonfon.commons.dialogs.ExportBlockedNumbersDialog
import com.fonfon.commons.dialogs.FilePickerDialog
...
class ManageBlockedNumbersActivity : BaseSimpleActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            val isDialer = remember {
                config.appId.startsWith("com.fonfon.dialer")
            }
    ...
    private fun maybeSetDefaultCallerIdApp() {
        if (isQPlus() && baseConfig.appId.startsWith("com.fonfon.dialer")) {
