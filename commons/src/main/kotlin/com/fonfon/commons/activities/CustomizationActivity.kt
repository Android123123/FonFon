...
import com.fonfon.commons.databinding.ActivityCustomizationBinding
import com.fonfon.commons.dialogs.*
import com.fonfon.commons.extensions.*
import com.fonfon.commons.helpers.*
import com.fonfon.commons.models.MyTheme
import com.fonfon.commons.models.RadioItem
import com.fonfon.commons.models.SharedTheme
...
class CustomizationActivity : BaseSimpleActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        isThankYou = packageName.removeSuffix(".debug") == "com.fonfon.thankyou"
        initColorVariables()
    ...
    private fun pickPrimaryColor() {
        if (!packageName.startsWith("com.fonfon.", true) && baseConfig.appRunCount > 50) {
            finish()
            return
        }
